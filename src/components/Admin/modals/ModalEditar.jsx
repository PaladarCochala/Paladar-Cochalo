...
export default function ModalVer({ restaurante, update }) {
  ...
  const [ubicacionMaps, setUbicacionMaps] = useState(restaurante.ubicacionMaps);
              ...
              <Grid container spacing={2}>
                <Grid item xs={6}>
                  ...
                  >
                    <TextField
                      id="outlined-required"
                      label="Coordenadas en Google Maps:"
                      defaultValue={restaurante.ubicacionMaps}
